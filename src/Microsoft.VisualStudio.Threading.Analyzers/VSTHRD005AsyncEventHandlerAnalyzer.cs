...
namespace Microsoft.VisualStudio.Threading.Analyzers
{
    ...
    public class VSTHRD005AsyncEventHandlerAnalyzer : DiagnosticAnalyzer
    {
        public const string Id = "VSTHRD005";

        internal static readonly DiagnosticDescriptor Descriptor = new DiagnosticDescriptor(
            id: Id,
            title: Strings.VSTHRD005_Title,
            messageFormat: Strings.VSTHRD005_MessageFormat,
            category: "Usage",
