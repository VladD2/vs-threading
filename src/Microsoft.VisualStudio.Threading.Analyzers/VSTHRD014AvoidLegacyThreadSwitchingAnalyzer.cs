namespace Microsoft.VisualStudio.Threading.Analyzers
{
    ...
    public class VSTHRD014AvoidLegacyThreadSwitchingAnalyzer : DiagnosticAnalyzer
    {
        public const string Id = "VSTHRD014";

        internal static readonly DiagnosticDescriptor Descriptor = new DiagnosticDescriptor(
            id: Id,
            title: Strings.VSTHRD014_Title,
            messageFormat: Strings.VSTHRD014_MessageFormat,
            category: "Usage",
