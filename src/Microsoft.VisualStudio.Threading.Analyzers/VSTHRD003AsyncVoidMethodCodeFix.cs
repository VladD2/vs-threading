...
namespace Microsoft.VisualStudio.Threading.Analyzers
{
    ...
    public class VSTHRD003AsyncVoidMethodCodeFix : CodeFixProvider
    {
        private static readonly ImmutableArray<string> ReusableFixableDiagnosticIds = ImmutableArray.Create(
            VSTHRD003AsyncVoidMethodAnalyzer.Descriptor.Id);
        ...
        private class VoidToTaskCodeAction : CodeAction
        {
            ...
            /// <inheritdoc />
            public override string Title => Strings.VSTHRD003_CodeFix_Title;

            /// <inheritdoc />
            public override string EquivalenceKey => VSTHRD003AsyncVoidMethodAnalyzer.Descriptor.Id;
