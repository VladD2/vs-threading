...
namespace Microsoft.VisualStudio.Threading.Analyzers
{
    ...
    public class VSTHRD006JtfRunAwaitTaskAnalyzer : DiagnosticAnalyzer
    {
        public const string Id = "VSTHRD006";

        internal static readonly DiagnosticDescriptor Descriptor = new DiagnosticDescriptor(
            id: Id,
            title: Strings.VSTHRD006_Title,
            messageFormat: Strings.VSTHRD006_MessageFormat,
            category: "Usage",
