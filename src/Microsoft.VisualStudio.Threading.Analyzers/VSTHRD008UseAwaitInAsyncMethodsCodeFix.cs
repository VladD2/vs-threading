namespace Microsoft.VisualStudio.Threading.Analyzers
{
    ...
    public class VSTHRD008UseAwaitInAsyncMethodsCodeFix : CodeFixProvider
    {
        internal const string AsyncMethodKeyName = "AsyncMethodName";

        private static readonly ImmutableArray<string> ReusableFixableDiagnosticIds = ImmutableArray.Create(
            VSTHRD008UseAwaitInAsyncMethodsAnalyzer.Id);
        ...
        private class ReplaceSyncMethodCallWithAwaitAsync : CodeAction
        {
            ...
            /// <inheritdoc />
            public override string EquivalenceKey => VSTHRD008UseAwaitInAsyncMethodsAnalyzer.Id;
