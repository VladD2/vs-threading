namespace Microsoft.VisualStudio.Threading.Analyzers.Tests
{
    ...
    public class VSTHRD009AvoidJtfRunInNonPublicMembersAnalyzerTests : DiagnosticVerifier
    {
        private static readonly DiagnosticResult[] NoDiagnostic = new DiagnosticResult[0];

        private DiagnosticResult expect = new DiagnosticResult
        {
            Id = VSTHRD009AvoidJtfRunInNonPublicMembersAnalyzer.Id,
            SkipVerifyMessage = true,
            Severity = DiagnosticSeverity.Info,
        };

        public VSTHRD009AvoidJtfRunInNonPublicMembersAnalyzerTests(ITestOutputHelper logger)
            : base(logger)
        {
        }
        ...
        {
            return new VSTHRD009AvoidJtfRunInNonPublicMembersAnalyzer();
        }
