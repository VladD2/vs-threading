namespace Microsoft.VisualStudio.Threading.Analyzers.Tests
{
    ...
    public class VSTHRD013OfferAsyncOptionAnalyzerTests : DiagnosticVerifier
    {
        private DiagnosticResult expect = new DiagnosticResult
        {
            Id = VSTHRD013OfferAsyncOptionAnalyzer.Id,
            SkipVerifyMessage = true,
            Severity = DiagnosticSeverity.Info,
        };

        public VSTHRD013OfferAsyncOptionAnalyzerTests(ITestOutputHelper logger)
            : base(logger)
        {
        }

        protected override DiagnosticAnalyzer GetCSharpDiagnosticAnalyzer() => new VSTHRD013OfferAsyncOptionAnalyzer();
