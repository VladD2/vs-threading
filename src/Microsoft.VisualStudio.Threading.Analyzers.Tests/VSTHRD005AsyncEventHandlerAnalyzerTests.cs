namespace Microsoft.VisualStudio.Threading.Analyzers.Tests
{
    ...
    public class VSTHRD005AsyncEventHandlerAnalyzerTests : DiagnosticVerifier
    {
        public VSTHRD005AsyncEventHandlerAnalyzerTests(ITestOutputHelper logger)
            : base(logger)
        {
        }
        ...
        private DiagnosticResult[] CreateExpects(DiagnosticResultLocation[] locations)
        {
            ...
            for (int i = 0; i < locations.Length; ++i)
            {
                ...
                {
                    Id = VSTHRD005AsyncEventHandlerAnalyzer.Id,
        ...
        {
            return new VSTHRD005AsyncEventHandlerAnalyzer();
        }
