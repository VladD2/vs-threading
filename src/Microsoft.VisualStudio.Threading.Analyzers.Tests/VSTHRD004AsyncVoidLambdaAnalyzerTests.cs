namespace Microsoft.VisualStudio.Threading.Analyzers.Tests
{
    ...
    public class VSTHRD004AsyncVoidLambdaAnalyzerTests : DiagnosticVerifier
    {
        private DiagnosticResult expect = new DiagnosticResult
        {
            Id = VSTHRD004AsyncVoidLambdaAnalyzer.Id,
            SkipVerifyMessage = true,
            Severity = DiagnosticSeverity.Warning,
        };

        public VSTHRD004AsyncVoidLambdaAnalyzerTests(ITestOutputHelper logger)
            : base(logger)
        {
        }
        ...
        {
            return new VSTHRD004AsyncVoidLambdaAnalyzer();
        }
