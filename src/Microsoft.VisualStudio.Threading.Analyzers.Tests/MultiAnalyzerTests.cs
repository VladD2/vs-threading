namespace Microsoft.VisualStudio.Threading.Analyzers.Tests
{
    ...
    public class MultiAnalyzerTests : DiagnosticVerifier
    {
        ...
        {
            var analyzers = from type in typeof(VSTHRD001SynchronousWaitAnalyzer).Assembly.GetTypes()
...
class Test {
    ...
    Task<int> FooAsync() {
        ...
        t.GetAwaiter().GetResult(); // VSTHRD001, VSTHRD008, VSTHRD009
        jtf.Run(async delegate { await BarAsync(); }); // VSTHRD008, VSTHRD009
