namespace Microsoft.VisualStudio.Threading.Analyzers.Tests
{
    ...
    public class VSTHRD011AvoidImpliedTaskSchedulerCurrentAnalyzerTests : DiagnosticVerifier
    {
        private DiagnosticResult expect = new DiagnosticResult
        {
            Id = VSTHRD011AvoidImpliedTaskSchedulerCurrentAnalyzer.Id,
            SkipVerifyMessage = true,
            Severity = DiagnosticSeverity.Warning,
        };

        public VSTHRD011AvoidImpliedTaskSchedulerCurrentAnalyzerTests(ITestOutputHelper logger)
            : base(logger)
        {
        }

        protected override DiagnosticAnalyzer GetCSharpDiagnosticAnalyzer() => new VSTHRD011AvoidImpliedTaskSchedulerCurrentAnalyzer();
