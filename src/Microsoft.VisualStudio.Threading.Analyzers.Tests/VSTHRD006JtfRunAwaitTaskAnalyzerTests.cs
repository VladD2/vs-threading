namespace Microsoft.VisualStudio.Threading.Analyzers.Tests
{
    ...
    public class VSTHRD006JtfRunAwaitTaskAnalyzerTests : DiagnosticVerifier
    {
        private DiagnosticResult expect = new DiagnosticResult
        {
            Id = VSTHRD006JtfRunAwaitTaskAnalyzer.Id,
            SkipVerifyMessage = true,
            Severity = DiagnosticSeverity.Warning,
        };

        public VSTHRD006JtfRunAwaitTaskAnalyzerTests(ITestOutputHelper logger)
            : base(logger)
        {
        }
        ...
        {
            return new VSTHRD006JtfRunAwaitTaskAnalyzer();
        }
