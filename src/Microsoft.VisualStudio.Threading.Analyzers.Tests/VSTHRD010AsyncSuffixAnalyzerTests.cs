namespace Microsoft.VisualStudio.Threading.Analyzers.Tests
{
    ...
    public class VSTHRD010AsyncSuffixAnalyzerTests : CodeFixVerifier
    {
        public VSTHRD010AsyncSuffixAnalyzerTests(ITestOutputHelper logger)
            : base(logger)
        {
        }
        ...
        {
            Id = VSTHRD010AsyncSuffixAnalyzer.Id,
        ...
        {
            return new VSTHRD010AsyncSuffixAnalyzer();
        }

        protected override CodeFixProvider GetCSharpCodeFixProvider()
        {
            return new VSTHRD010AsyncSuffixCodeFix();
        }
