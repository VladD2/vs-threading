namespace Microsoft.VisualStudio.Threading.Analyzers.Tests
{
    ...
    public class VSTHRD003AsyncVoidMethodAnalyzerTests : DiagnosticVerifier
    {
        private DiagnosticResult expect = new DiagnosticResult
        {
            Id = VSTHRD003AsyncVoidMethodAnalyzer.Id,
            SkipVerifyMessage = true,
            Severity = DiagnosticSeverity.Warning,
        };

        public VSTHRD003AsyncVoidMethodAnalyzerTests(ITestOutputHelper logger)
            : base(logger)
        {
        }
        ...
        {
            return new VSTHRD003AsyncVoidMethodAnalyzer();
        }
