namespace Microsoft.VisualStudio.Threading.Analyzers.Tests
{
    ...
    public class VSTHRD008UseAwaitInAsyncMethodsAnalyzerTests : CodeFixVerifier
    {
        private DiagnosticResult expect = new DiagnosticResult
        {
            Id = VSTHRD008UseAwaitInAsyncMethodsAnalyzer.Id,
            SkipVerifyMessage = true,
            Severity = DiagnosticSeverity.Warning,
        };

        public VSTHRD008UseAwaitInAsyncMethodsAnalyzerTests(ITestOutputHelper logger)
            : base(logger)
        {
        }

        protected override DiagnosticAnalyzer GetCSharpDiagnosticAnalyzer() => new VSTHRD008UseAwaitInAsyncMethodsAnalyzer();

        protected override CodeFixProvider GetCSharpCodeFixProvider() => new VSTHRD008UseAwaitInAsyncMethodsCodeFix();
