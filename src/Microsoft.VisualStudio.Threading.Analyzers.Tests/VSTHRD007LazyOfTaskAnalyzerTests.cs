namespace Microsoft.VisualStudio.Threading.Analyzers.Tests
{
    ...
    public class VSTHRD007LazyOfTaskAnalyzerTests : DiagnosticVerifier
    {
        private DiagnosticResult expect = new DiagnosticResult
        {
            Id = VSTHRD007LazyOfTaskAnalyzer.Id,
            SkipVerifyMessage = true,
            Severity = DiagnosticSeverity.Error,
        };

        public VSTHRD007LazyOfTaskAnalyzerTests(ITestOutputHelper logger)
            : base(logger)
        {
        }
        ...
        {
            return new VSTHRD007LazyOfTaskAnalyzer();
        }
